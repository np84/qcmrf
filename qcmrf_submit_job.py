...
if args.layout is not None:
	...
	layouts = {'ibm_auckland':[0,1,4,7,6,2,3,5],'ibmq_mumbai':[7,10,12,13,15,18,14,11],'ibm_cairo':[21,23,24,25,26,22,15,17],'ibm_hanoi':[6,7,4,1,2,3,5,8,11],'ibmq_ehningen':[10,12,13,14,16,19,20,22]}
...
runtime_inputs = {
		...
		"graphs": [[[0]],[[0,1]],[[0,1],[1,2]],[[0,1],[1,2],[2,3]],[[0,1,2,3]]],
		"thetas": None,
		"gammas": None,
		"betas": None,
		"repetitions": 10,
